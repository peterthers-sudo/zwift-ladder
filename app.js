...
const APP_VERSION = 'v1.3.101'; // bump this on every update
...
Reply in English. Max 550 words total. Be direct and coach-like — no generic filler.`;
  ...
  try {
    ...
    const formatted = text
      ...
      .replace(/\n/g, '<br>');
    out.innerHTML =
      `<div style="margin-bottom:4px;font-size:0.85rem;letter-spacing:3px;color:#7fff6b;font-weight:700">🏋 AI TRAINING PLAN</div>` +
