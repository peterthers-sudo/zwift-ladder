    ...
    try:
        ...
        for race in all_races:
            ...
            entry = {
                ...
                "time_gun":    clean_num(race.get("time_gun")),
                "time_hms":    race.get("time_hms"),
                "gap":         clean_num(race.get("gap")),
    ...
    try:
        ...
        for activity in all_activities:
            ...
            rides.append({
                ...
                "time_gun":    clean_num(activity.get("time_gun")),
                "time_hms":    activity.get("time_hms"),
                "gap":         clean_num(activity.get("gap")),
